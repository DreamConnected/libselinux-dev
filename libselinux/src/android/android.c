...
static const path_alts_t secure_service_context_paths = { .paths = {
	{
		"/system/etc/selinux/secure_service_contexts",
		"/secure_service_contexts"
	},
	{
...
{
	return context_handle(SELABEL_CTX_ANDROID_SECURE_SERVICE, &secure_service_context_paths,
                              "secure_service");
}
