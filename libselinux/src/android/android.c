...
static const struct path_alts service_context_paths = { .paths = {
	{
...
static const struct path_alts hwservice_context_paths = { .paths = {
	{
...
static const struct path_alts vndservice_context_paths = { .paths = {
	{
...
static const struct path_alts keystore2_context_paths = { .paths = {
	{
...
size_t find_existing_files(
		const struct path_alts *path_sets,
...
struct selabel_handle* context_handle(
		unsigned int backend,
		const struct path_alts *context_paths,
		const char *name)
{
