...
/* Sets the file context handle. The handle will be used when looking up app
 * contexts. Must be called using the output of
...
/* Sets the context of the current process based on the information provided.
 * Returns -1 if no matching context is found or the transition failed */
...
/* Restores the security context of a package. */
