...
#define EXTENDED_PERMS_SIZE_BITS 256
#define EXTENDED_PERMS_SIZE_BYTES (EXTENDED_PERMS_SIZE_BITS/8)
#define EXTENDED_PERMS_LEN (EXTENDED_PERMS_SIZE_BYTES/sizeof(uint32_t))
